 ...
 * followed by two digits, a special character, and an additional character if needed.
 * Spaces in the username are replaced with underscores.
 *
...
function GENERATE_PASSWORD_FROM_USERNAME(username) {
  ...
  var namePart = username.substring(0, 5).replace(/\s/g, '_').toLowerCase();
